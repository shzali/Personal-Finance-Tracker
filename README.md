...
A platform designed to meet my needs of tracking my finances. Currently early in development.

[View live demo on Netlify.](https://6a734323dbda70912c65ecb1--personalfinancetrackershzali.netlify.app/)
...
- Calculates the percentages of the monthly income for investing and saving based on given ratios, after expenses.
...
See [changelog.md](./changelog.md) for more information on the application updates for each day there was a commit.
